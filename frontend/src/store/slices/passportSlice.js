...
export const getPassport = createAsyncThunk(
  ...
  async function (id, { rejectWithValue, dispatch }) {
    try {
      let response = await fetch(`${API.GET_PASSPORT}/${id}`, {
        method: "get",
        headers: {
          Authorization:
...
export const updatePassport = createAsyncThunk(
  ...
  async function (data, { rejectWithValue, dispatch }) {
    try {
      let response = await fetch(`${API.UPDATE_PASSPORT}/${data.id}`, {
        method: "PATCH",
        headers: {
          Authorization:
            "Bearer " + localStorage.getItem("PP-manager-accessToken"),
...
export const createPassportReport = createAsyncThunk(
  "passport/report",
  async function (data, { rejectWithValue, dispatch }) {
    try {
      let response = await fetch(API.CREATE_PASSPORT_REPORT, {
        method: "post",
        headers: {
          "Content-Type": "application/json",
          Authorization:
