...
const CREATE_PASSPORT_REPORT = `${HOST}/partner/passport/report`;
const CREATE_REQUESTS_REPORT = `${HOST}/partner/request/report`;
...
const API = {
  ...
  PARSE_PASSPORTS,
  PARSE_REQUESTS,
  CREATE_PASSPORT_REPORT,
  CREATE_REQUESTS_REPORT,
  GET_PROGRAMS
};
