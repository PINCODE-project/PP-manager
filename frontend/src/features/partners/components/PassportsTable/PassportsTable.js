    ...
    const getUidPassportDropdown = (value, record) => [
        {
            ...
            label: (
                <a
                    target="_blank"
                    href={
                        "https://partner.urfu.ru/ptraining/services/learning/#/passport/" +
                        record.id
                    }
                >
                            ...
                            <Column
                                ...
                                render={ (value, record) => {
                                    return (
                                        ...
                                        >
                                            <a onClick={ (e) => e.preventDefault() } >{ value }</a >
                                        </Dropdown >
                                    );
                                } }
                    ...
                    if (column.key === "course")
                        return (
                            <Column
                                ...
                                onFilter={ (value, record) =>
                                    record.course.filter((course) => course.number === value)
                                        .length !== 0
                                }
                            />
                        );
                    ...
                    if (column.key === "available_seats_number")
                        return (
                            <Column
                                ...
                                sorter={ (a, b) =>
                                    a.available_seats_number - b.available_seats_number
                                }
                            />
                        );
