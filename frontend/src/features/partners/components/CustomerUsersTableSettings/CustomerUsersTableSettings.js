...
import styles from "./CustomerUsersTableSettings.module.css"
...
export default function CustomerUsersTableSettings(props) {
    ...
    return (
        <Drawer
            title="Настройки таблицы представителей заказчиков"
            onClose={() => {
                props.setTableColumns(JSON.parse(localStorage.getItem("PP-manager-customer-users-columns")) || initialCustomerUsersTableColumns)
        ...
        >
            <div className={styles.content}>
                <div className={styles.buttons}>
                    <Button
                        ...
                        onClick={() => {
                            localStorage.setItem(
                                "PP-manager-customer-users-columns",
                    ...
                    <Button
                        onClick={() => {
                            props.setTableColumns(initialCustomerUsersTableColumns);
                            localStorage.setItem(
                                "PP-manager-customer-users-columns",
                                JSON.stringify(initialCustomerUsersTableColumns)
                            );
                ...
                <div className={styles.columnSwitchs}>
                    {
                        initialCustomerUsersTableColumns.map(column => {
