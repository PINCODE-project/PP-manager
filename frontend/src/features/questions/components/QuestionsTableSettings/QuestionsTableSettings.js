...
import styles from "./QuestionsTableSettings.module.css"
import {initialQuestionsTableColumns} from "../../pages/QuestionsPage/QuestionsPage";
...
export default function QuestionsTableSettings(props) {
    ...
    return (
        <Drawer
            ...
            onClose={() => {
                props.setTableColumns(JSON.parse(localStorage.getItem("PP-manager-questions-columns")) || initialQuestionsTableColumns)
        ...
        >
            <div className={styles.content}>
                <div className={styles.buttons}>
                    ...
                    <Button
                        onClick={() => {
                            props.setTableColumns(initialQuestionsTableColumns);
                            localStorage.setItem(
                                "PP-manager-questions-columns",
                                JSON.stringify(initialQuestionsTableColumns)
                            );
                ...
                <div className={styles.columnSwitchs}>
                    {
                        initialQuestionsTableColumns.map(column => {
