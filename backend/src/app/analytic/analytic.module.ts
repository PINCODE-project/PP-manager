...
@Module({
    imports: [TypeOrmModule.forFeature([Passport, Request, Project, CustomerCompany, CustomerUser, Course, Tag, Period, Student]), SSEModule],
    controllers: [AnalyticController],
    providers: [AnalyticService, PartnerService, PassportService, ProjectService, RequestService, CustomerCompanyService, CustomerUserService, PeriodService, StudentService],
})
